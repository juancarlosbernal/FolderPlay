...
pub const GRID_TILE_SIZE: i32 = 150;
...
mod imp {
    ...
    impl ObjectSubclass for GridCover {
        const NAME: &'static str = "GridCover";
        type Type = super::GridCover;
        type ParentType = gtk::Widget;
    }

    impl ObjectImpl for GridCover {
        fn constructed(&self) {
    ...
    impl WidgetImpl for GridCover {
        fn measure(&self, _orientation: gtk::Orientation, _for_size: i32) -> (i32, i32, i32, i32) {
            (GRID_TILE_SIZE, GRID_TILE_SIZE, -1, -1)
        }
...
glib::wrapper! {
    pub struct GridCover(ObjectSubclass<imp::GridCover>)
        @extends gtk::Widget;
}
